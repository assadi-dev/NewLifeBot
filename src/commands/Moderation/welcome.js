...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .setDescription("Activer le message de bienvenue sur le serveur"),
  async execute(interaction) {
    ...
    const embed = new EmbedBuilder()
      .setColor("Blue")
      .setDescription(
        `:white_check_mark: Vous avez defini le channel${channel} pour affiché les messages de bienvenue`
      );
